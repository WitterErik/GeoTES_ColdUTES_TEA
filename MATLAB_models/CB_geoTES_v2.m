...
%% Carnot Battery
CB.Tmax = 158.8 ; % Hot storage temperature, C
CB.Tmin = 20 ;   % Cold storage temperature, C
...
if gHTES.charge_injection.p < 30
    gHTES.charge_injection.p = 30;
...
gCTES.discharge_injection.p = 30 ;
...
Cold_source_InjPumping_Estimation = InjectionPumpingCost(ResTemp,InjTemp,Iflowrate,Pflowrate,PressureThermalSource,gCTES.discharge_inj_Nwell,7645,gCTES.depth,200,"Small","Liner",1.533,"Charge");
...
Cold_sink_ProdPumping_Estimation = ProductionPumpingCost(ResTemp,Pflowrate,gCTES.discharge_prod_Nwell,6370,gCTES.depth,200,"Small","Lineshaft","Liner",1.553);
...
Cold_sink_InjPumping_Estimation = InjectionPumpingCost(ResTemp,InjTemp,Iflowrate,Pflowrate,PressureThermalSource,gCTES.discharge_inj_Nwell,7645,gCTES.depth,200,"Small","Liner",1.533,"Charge");
...
econ.Eout = HE.Wout_tot - cold_discharge_production_pump - cold_discharge_injection_pump - hot_discharge_injection_pump - hot_discharge_production_pump ;
