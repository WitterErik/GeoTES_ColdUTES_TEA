...
op_hour1 = [1:24]; % List of hours of operation
op_hour2 = [1:24]; % List of hours of operation
op_hour3 = [1:24]; % List of hours of operation
...
LTPC_design.Wout  = 15 ;% Power output, MW-e
...
gTES_fluid = 'water';
gTES_mode = "separate"; % Three operation modes "separate", "continuous", "push-pull"
